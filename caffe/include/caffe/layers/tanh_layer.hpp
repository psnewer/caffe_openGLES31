...
class TanHLayer : public NeuronLayer<Dtype> {
 ...
 protected:
  ...
  void forward_tanh(const GLuint input, const GLuint output);
  ...
  const char *csSrc[2] = {
        "#version 310 es\n",
         ...
         void main() {\
	     top[gl_WorkGroupID.z*gl_NumWorkGroups.y*gl_NumWorkGroups.x + gl_WorkGroupID.y*gl_NumWorkGroups.x + gl_WorkGroupID.x] = tanh(bottom[gl_WorkGroupID.z*gl_NumWorkGroups.y*gl_NumWorkGroups.x + gl_WorkGroupID.y*gl_NumWorkGroups.x + gl_WorkGroupID.x]);\ 
         }"
    };
};
