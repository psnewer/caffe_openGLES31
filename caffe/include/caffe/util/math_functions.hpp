...
template <typename Dtype>
void caffe_shader_gemm(const int num_output, const int num_conv_channel, const int output_width, const int output_height, const int kernel_width, const int kernel_height,
